# Documento de Plan de Trabajo — LowRace (programado con IA)

**Autor:** Thiago Almada
**Proyecto:** LowRace — Juego de carreras 3D low-poly
**Motor:** Unity (URP) + C#
...
LowRace es un juego de carreras single-player (asincrónicamente competitivo por
...
- Antes de cada entrega se actualiza el checklist en `docs/cronograma.md`.
